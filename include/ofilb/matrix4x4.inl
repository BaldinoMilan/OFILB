...
namespace oi {
	...
	tmat4<T> adjugate(const tmat4<T>& m) noexcept
	{
		return tmat4<T>(
		   ...
		   -m[0][3]*m[2][2]*m[3][0] - m[0][2]*m[2][0]*m[3][3] - m[0][0]*m[1][0]*m[3][2],
			
		   -m[0][0]*m[1][2]*m[3][3] - m[0][2]*m[1][2]*m[3][0] - m[0][3]*m[1][0]*m[3][2]
		   +m[0][3]*m[1][2]*m[3][1] + m[0][2]*m[1][0]*m[3][3] + m[0][0]*m[1][3]*m[3][2],
